...
Here need to pay attention to status 'shipped'. Products in this status was delivered from seller, but for some reason no data about delivered to customer. _**Reccomedation is to understand this is because of client cancel ot lost of the product on the way**_
